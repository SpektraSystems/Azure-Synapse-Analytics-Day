...
<validation step="ef67b27b-51b2-416b-bd54-ce43a089fa7a" />

## Summary

In this lab, you have completed the following:

- Created a Power BI dataset in Azure Synapse.

- Built a Power BI report in Synapse.

- Viewed and analyzed the underlying SQL query.
